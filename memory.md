...
TIPRs(8):#312#335#357#368#538#541#543#548 all open/draft/mergeable:clean/comments:0(NO human feedback EVER since Mar);#373(maintainer)open/unstable/comments:1(old,updated2026-04-09,head 36b0bcc)
PRbase:#312=51f94a3 #335=7e50d57 #357#368#538#541#543#548=ce545ec(all still clean,no conflict);CI NOT auto-run on bot PRs
verified-2026-07-06:8 TI PRs=open/draft/comments:0(updated_at==created_at,unchanged);#373=open/unstable/comments:1/base ce545ec/head 36b0bcc/updated2026-04-09/unchanged;origin/main=ce545ec unchanged(no commits since 2026-03-23);#624 comments:0,checkboxes untouched
list_pull_requests caps ~page1;TI PRs<#377 fell off page->search_pull_requests 'is:pr is:open in:title [Test Improver]' returns all 8
monthly:July summary=#624(TI);other bots #623(RepoAssist) #626(PerfImprover);#624 created 2026-07-01,0 checkboxes ticked ever;prepended 2026-07-06 run entry

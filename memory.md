...
verified-2026-07-12:8 TI PRs=open/draft/comments:0(updated_at==created_at,unchanged);#373 unchanged(head 36b0bcc,base ce545ec,comments:1,updated 2026-04-09,unstable);origin/main=ce545ec unchanged(no commits since 2026-03-23);#624 checkboxes untouched(all 10 unchecked),comments:0
list_pull_requests caps ~page1;TI PRs<#377 fell off page->search_pull_requests 'is:pr is:open in:title [Test Improver]' returns all 8;search_issues output overflows->issue_read get direct on #624
monthly:July summary=#624(TI);other bots #623(RepoAssist) #626(PerfImprover);#624 created 2026-07-01,0 checkboxes ticked ever;prepended 2026-07-12 run entry(run 29189691185,10:49UTC);trimmed run history to bound body(kept 07-12..07-05 daily+07-01 rollover;dropped 07-03/07-04;compressed older entries)

...
verified-2026-07-04:8 TI PRs=open/draft/comments:0(updated_at==created_at,unchanged);#373=open/unstable/comments:1/base ce545ec/updated2026-04-09/unchanged;origin/main=ce545ec unchanged(no commits since 2026-03-23);#624 comments:0
list_pull_requests caps ~page1(#377-#625);TI PRs<#377 fell off page->search_pull_requests title:[Test Improver] works(returns all 8)
monthly:July summary=#624(TI);other bots #623(RepoAssist) #626(PerfImprover);#624 created 2026-07-01,0 checkboxes ticked ever;prepended 2026-07-04 run entry

...
verified-this-run(2026-06-11):all 8 TI PRs via search=open/draft/comments:0;#373 via get=open/unstable/comments:1/updated 2026-04-09;#586 comments:0,NO checkboxes ticked(all [ ]);only open testing-label issue=#586 itself;main=ce545ec(unchanged since 2026-03-23);no new commits
...
summary:June=#586;updated w/ 2026-06-11 run entry(prepended;kept 06-10 full,folded earlier June into archive note thru 06-09);0 human comments,0 checkboxes ticked

...
## State 09-04 (cmds revalidated: 2265/3/6/0, tc+lint clean)
main ce545ec (unmoved 166d). Same 9 TI PRs open (#312 #335 #357 #368 #538 #541 #543 #548 #690), 0 human comments. VERIFIED+urged merge: #745 #741 #748 #728(+#711). #611 open.
...
UNAUDITED: DONE = glob, hl-client, injection-hl, diff/diff, editor-view, diff-editor-view, diff/patch, multi-file, diff/controller, anchor+viewport, excerpt, diff-client, selection, cursor, input-handler, editor._mergeSelections + multi-sel edit paths. NEXT = hl-client WORKER; undo/redo (_applyInverse TOP-DOWN = CORRECT, proved 09-04; TESTED? #312); slot_map.set.

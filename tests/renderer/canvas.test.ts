...
// The token-rendering algorithm (`_renderTokenizedLine`) is covered in
// `canvas-token-rendering.test.ts`, which drives the real renderer. This file
// previously modelled that algorithm with a local `simulateTokenRendering()`
// copy, which asserted nothing about `src/`.

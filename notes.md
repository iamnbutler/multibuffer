...
last:2026-06-07 r:27099935705 T2+T4+T5+T7
...
0607:maint run. All4 perf-PRs mergeable_state:clean (#310 base51f94a3,#339 base7e50d57,#565/#575 ce545ec). Since 0606 only docs PRs:#594/#595 open,#592/#593 closed(Doc Unbloat). Main unchanged ce545ec. No perf PRs merged/closed; SA-list unchanged(59). Perf issues #417/#446/#496/#540 no new human comments(not in updated-issues list). #588 0 maint comments,no checkbox changes. Prepended run entry to #588.

...
last:2026-06-12 r:27433249928 T2+T4+T5+T7
...
0612:maint run. All4 perf-PRs mergeable_state:clean (API verified: #310 base51f94a3,#339 base7e50d57,#565/#575 ce545ec; all draft,no CI fail,no conflicts). Since 0611 only docs PRs touched(#601 upd 0612,#600 open;both Doc Unbloat). Main unchanged ce545ec. No perf PRs merged/closed; SA-list unchanged(59). #588 had 0 comments=no maint instructions/checkbox changes. Perf issues #417/#446/#496/#540 untouched since May(#540 last 0508). Prepended 0612 run entry to #588.

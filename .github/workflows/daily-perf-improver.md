...
- **Read CLAUDE.md first**: before starting work on any pull request, read the repository's `CLAUDE.md` file (if present) to understand project-specific conventions.
